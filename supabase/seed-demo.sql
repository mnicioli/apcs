...
insert into public.members (id, code, status, origin, profile_type, full_name, whatsapp, email, city, state, organization, farm_name, production_city, sow_count, cnpj, activity_area, job_title, legal_name, trade_name, interests, joined_at, notes, contact_id, created_at) values
  ('ddddddd4-0000-4000-8000-000000000001', 'APCS-0001', 'active',   'import',      'suinocultor',  'Joana Ribeiro',      '42999180011', 'joana.ribeiro@granjaboavista.com.br', 'Ponta Grossa',    'PR', 'Granja Boa Vista',    'Granja Boa Vista',   'Ponta Grossa',    600,  null,             null, null, null, null, '{"Nutricao","Sanidade"}',        current_date - 1200, 'Associada desde a fundacao do nucleo regional.', 'ddddddd1-0000-4000-8000-000000000001', now() - interval '400 days'),
  ('ddddddd4-0000-4000-8000-000000000002', 'APCS-0002', 'active',   'import',      'suinocultor',  'Ricardo Tanaka',     '45998120044', 'ricardo.tanaka@granjatanaka.com.br',  'Marechal Rondon', 'PR', 'Granja Tanaka',       'Granja Tanaka',      'Marechal Rondon', 1800, null,             null, null, null, null, '{"Mercado","Genetica"}',         current_date - 900,  null, 'ddddddd1-0000-4000-8000-000000000004', now() - interval '380 days'),
  ('ddddddd4-0000-4000-8000-000000000003', 'APCS-0003', 'active',   'import',      'profissional', 'Beatriz Almeida',    '45999560055', 'beatriz.almeida@cooperoeste.com.br',  'Cascavel',        'PR', 'Cooper Oeste',        null,                 null,              null, null,             'Assistencia tecnica', 'Medica veterinaria', null, null, '{"Sanidade","Bem-estar animal"}', current_date - 700, null, 'ddddddd1-0000-4000-8000-000000000005', now() - interval '300 days'),
  ...
  ('ddddddd4-0000-4000-8000-000000000005', 'APCS-0005', 'inactive', 'import',      'suinocultor',  'Paulo Schneider',    '42998330066', 'paulo.schneider@granjasp.com.br',     'Palmeira',        'PR', 'Granja SP',           'Granja Sao Paulo',   'Palmeira',        120,  null,             null, null, null, null, '{"Custo de producao"}',          current_date - 1500, 'Nao renovou a anuidade de 2025.', 'ddddddd1-0000-4000-8000-000000000006', now() - interval '600 days'),
  ('ddddddd4-0000-4000-8000-000000000006', 'APCS-0006', 'active',   'manual',      'suinocultor',  'Eduardo Ferrari',    '42999650088', 'eduardo@granjaferrari.com.br',        'Carambei',        'PR', 'Granja Ferrari',      'Granja Ferrari',     'Carambei',        450,  null,             null, null, null, null, '{"Mercado","Nutricao"}',         current_date - 120,  null, 'ddddddd1-0000-4000-8000-000000000008', now() - interval '120 days'),
  ('ddddddd4-0000-4000-8000-000000000007', 'APCS-0007', 'suspended','import',      'profissional', 'Anderson Vieira',    '42999120100', 'anderson.vieira@apcs-demo.com.br',    'Guarapuava',      'PR', 'Agro Vieira',         null,                 null,              null, null,             'Comercial', 'Consultor', null, null, '{"Mercado"}',                    current_date - 800,  'Vinculo suspenso a pedido do associado.', 'ddddddd1-0000-4000-8000-000000000010', now() - interval '350 days'),
  ('ddddddd4-0000-4000-8000-000000000008', 'APCS-0008', 'active',   'application', 'suinocultor',  'Luciana Prado',      '42998910099', 'luciana.prado@granjaprado.com.br',    'Irati',           'PR', 'Granja Prado',        'Granja Prado',       'Irati',           45,   null,             null, null, null, null, '{"Sanidade"}',                   current_date - 10,   'Entrou pelo formulario do site.', 'ddddddd1-0000-4000-8000-000000000009', now() - interval '10 days')
on conflict (id) do nothing;
...
insert into public.membership_applications (id, status, profile_type, full_name, whatsapp, email, city, state, organization, farm_name, production_city, sow_count, cnpj, activity_area, job_title, legal_name, trade_name, interests, consent_accepted, consent_at, consent_policy_version, dedupe_key, source_ip_hash, user_agent, created_at) values
  ('ddddddd5-0000-4000-8000-000000000001', 'pending', 'suinocultor',  'Helena Bortolini',     '42998220011', 'helena.bortolini@granjahb.com.br', 'Ipiranga',     'PR', 'Granja HB',          'Granja HB',    'Ipiranga', 200,  null,             null,              null,          null,                         null,      '{"Nutricao","Mercado"}', true, now() - interval '4 hours',  '1', 'demo-dedupe-0001', 'demo-ip-21', 'Mozilla/5.0 (demo)', now() - interval '4 hours'),
  ...
  ('ddddddd5-0000-4000-8000-000000000003', 'pending', 'profissional', 'Tiago Marchi',         '42999770033', 'tiago.marchi@consultoria.com.br',  'Ponta Grossa', 'PR', 'Marchi Consultoria', null,           null,       null, null,             'Nutricao animal', 'Zootecnista', null,                         null,      '{"Nutricao"}',           true, now() - interval '2 days',   '1', 'demo-dedupe-0003', 'demo-ip-23', 'Mozilla/5.0 (demo)', now() - interval '2 days'),
  ('ddddddd5-0000-4000-8000-000000000004', 'pending', 'suinocultor',  'Luciana Prado',        '42998910099', 'luciana.prado@granjaprado.com.br', 'Irati',        'PR', 'Granja Prado',       'Granja Prado', 'Irati',    45,   null,             null,              null,          null,                         null,      '{"Sanidade"}',           true, now() - interval '12 days',  '1', 'demo-dedupe-0004', 'demo-ip-24', 'Mozilla/5.0 (demo)', now() - interval '12 days'),
  ('ddddddd5-0000-4000-8000-000000000005', 'pending', 'profissional', 'Marcos Aurelio Reis',  '41998660044', 'marcos.reis@exemplo.com.br',       'Curitiba',     'PR', null,                 null,           null,       null, null,             'Outro setor',     'Analista',    null,                         null,      '{}',                     true, now() - interval '15 days',  '1', 'demo-dedupe-0005', 'demo-ip-25', 'Mozilla/5.0 (demo)', now() - interval '15 days')
on conflict (id) do nothing;
