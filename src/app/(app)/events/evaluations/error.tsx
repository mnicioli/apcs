...
/**
 * O que aparece quando a leitura da gestão de avaliações falha.
 *
...
export default function EvaluationsError({
  ...
  useEffect(() => {
    console.error(`[evaluations] falha ao carregar a tela: ${error.message}`);
  }, [error]);
      ...
      <Card>
        <CardContent className="space-y-4 p-6">
          <p role="alert" className="text-sm">
            Não foi possível carregar a gestão de avaliações. Tente novamente.
          </p>
