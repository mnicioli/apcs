...
/**
 * O que aparece quando a leitura da tabulação dos resultados falha.
 *
...
export default function ResultsError({
  ...
  useEffect(() => {
    console.error(`[results] falha ao carregar a tela: ${error.message}`);
  }, [error]);
      ...
      <Card>
        <CardContent className="space-y-4 p-6">
          <p role="alert" className="text-sm">
            Não foi possível carregar a tabulação dos resultados. Tente novamente.
          </p>
